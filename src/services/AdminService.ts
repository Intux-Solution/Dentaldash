...
export const AdminService = {
  ...
  createPlan: (data: { name: string; description?: string; price_monthly: number; price_yearly?: number; features?: string[]; feature_keys?: string[]; sort_order?: number; trial_days?: number | null }) =>
    callAdminApi('create_plan', data),

  updatePlan: (planId: string, data: { name?: string; description?: string | null; price_monthly?: number; price_yearly?: number | null; features?: string[]; feature_keys?: string[]; sort_order?: number; trial_days?: number | null }) =>
